...
class OptionArray implements \Magento\Framework\Option\ArrayInterface {
    ...
    public function cardOptionArray() {
    ...
    public function cardtypeOptionArray() {
        return [
    ...
    public function suppotedcardOptArr() {
        return [
    ...
    public function netbankingOptArr() {
        return [
